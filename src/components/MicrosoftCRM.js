...
function MicrosoftCRM(){
    return(
        <div>
           ...
           <div class="card mb-3">
            <img src="https://tse1.mm.bing.net/th?id=OIP.JBN3y8Rpt94D1mSP809X0QHaEF&pid=Api&P=0&h=220" class="card-img-top" alt="..."/>
            <div class="card-body">
                <h5 class="card-title">Microsoft Dynamics CRM</h5>
